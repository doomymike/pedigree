    ...
    public MenuFrame(){
        ...
        buttonOne.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    next = new Display(Export.unyeet("autodom.txt"));
        ...
        buttonTwo.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    next = new Display(Export.unyeet("autorec.txt"));
                } catch (IOException e1) {
                    e1.printStackTrace();
                }
                dispose();
        ...
        buttonThree.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    next = new Display(Export.unyeet("xdom.txt"));
                } catch (IOException e1) {
                    e1.printStackTrace();
                }
                dispose();
        ...
        buttonFour.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
				try {
					next = new Display(Export.unyeet("xrec.txt"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}
				dispose();
        ...
        buttonFive.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
				try {
					next = new Display(Export.unyeet("ylink.txt"));
				} catch (IOException e1) {
					e1.printStackTrace();
				}
				dispose();
